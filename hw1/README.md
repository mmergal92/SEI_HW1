...
1. Create a folder named `first_homework` somewhere convenient, like your `Desktop`
...
Answer the questions, write some code, and submit the files via pull request (see instructions at the bottom). Note: there are **5 Sections** in this homework
...
- Must be submitted before the next class day
...
Submit a pull request to this repo with the title of the pull request as:
`First_Name Last_Name - Assignment_Name`
...
* Pulls changes from the remote repo to your local repo
